              ...
              {menuItems.map((m) => {
                ...
                if (m.hasSubmenu && cfg) {
                  return (
                    <div key={m.label} className="mb-1">
                      <button
                        onClick={() => handleDropdownClick(cfg)}
                        className="w-full px-4 py-3 flex justify-between items-center rounded-lg bg-gray-50 hover:bg-gray-100 transition-all"
                      >
                        <div className="flex items-center gap-2">
                      ...
                      {opened && (
                        <div className={`p-2 bg-gray-50/50 ${dropdownStyle === 'simple' ? 'space-y-1' : 'grid grid-cols-2 gap-3'}`}>
                ...
                return (
                  <button
                    ...
                    className={`w-full px-4 py-3 flex items-center gap-2 rounded-lg mb-1 ${active ? "bg-gray-100" : "bg-gray-50 hover:bg-gray-100"
                      }`}
                  >
                    <m.icon size={17} className="text-gray-700" />
                    <span className="font-medium text-gray-900">{m.label}</span>
