...
export default function GridCompThree({ dataSource, headingTitle, subHeadingTitle, className }: Props) {
                  ...
                  <div className="flex gap-3 p-4 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 flex items-center justify-between text-xs text-gray-500">
                        <div className="flex items-center gap-2"><Calendar size={14} /><span>{String(created)}</span></div>
                        {viewCount > 0 && (
