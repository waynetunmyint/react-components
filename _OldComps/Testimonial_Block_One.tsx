...
export default function TestimonialBlockOne({ dataSource, headingTitle, subHeadingTitle }: Props) {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 py-12`}>
      ...
      <div className="text-center mb-12">
        ...
        <p className={`text-gray-500text-sm md:text-base max-w-2xl mx-auto`}>
