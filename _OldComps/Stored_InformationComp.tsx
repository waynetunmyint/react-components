...
----------------------------- */
export function UniversalGetStoredData(keyString: string){
...
----------------------------- */
export const UniversalGetStoredProfile = () =>UniversalGetStoredData("StoredProfile");

export const UniversalGetStoredItem = () =>UniversalGetStoredData("StoredItem");

export const UniversalGetStoredPage = () =>UniversalGetStoredData("StoredPage");

export const UniversalGetStoredUser = () =>UniversalGetStoredData("StoredUser");
