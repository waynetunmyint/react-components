...
export default function SliderBlockNine({ dataSource }: Props) {
  ...
  return (
    <div 
      className="relative w-full h-[600px] overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900 -mt-14"
