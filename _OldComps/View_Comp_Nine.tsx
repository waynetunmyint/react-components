...
const ViewCompNine: React.FC<Props> = ({ customAPI }) => {
  ...
  const renderLinkButton = (url: string | undefined, label: string, icon?: React.ReactNode) => {
    ...
    const linkStyles: Record<string, string> = {
      Website: "bg-blue-600 text-white hover:bg-blue-700 border-blue-600 hover:shadow-lg hover:shadow-blue-200",
