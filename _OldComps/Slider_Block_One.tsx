...
export default function SliderBlockOne({ dataSource }: Props) {
  ...
  return (
    <div 
      className="relative w-full h-[600px] overflow-hidden bg-gradient-to-br from-gray-900 via-black to-gray-900 rounded-2xl"
    ...
    >
      ...
      <div className="relative h-full">
        ...
        <div
          ref={sliderRef}
          className="no-scrollbar w-full h-full overflow-x-hidden scroll-smooth flex"
        >
          {loading ? (
            ...
            items.map((item, idx) => {
              ...
              return (
                <div
                  key={item.Id || idx}
                  className="slider-card relative w-full h-full flex-shrink-0 overflow-hidden group"
                >
