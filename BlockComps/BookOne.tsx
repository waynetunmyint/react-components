        ...
        <div id="page-block-book" className="py-16 px-4 bg-page text-page transition-colors duration-300">
                        ...
                        items.map((item, idx) => {
                            ...
                            if (viewMode === "list") {
                                return (
                                    <div
                                        ...
                                        className="group flex flex-col sm:flex-row gap-6 bg-white rounded-3xl p-5 shadow-sm hover:shadow-xl border border-gray-100 transition-all duration-300 cursor-pointer"
                                    >
                                        <div className="w-full sm:w-48 aspect-[4/3] rounded-2xl overflow-hidden relative bg-gray-100">
                            ...
                            return (
                                <div
                                    key={item.Id || idx}
                                    onClick={() => handleNavigation(item.Id)}
                                    className="group relative bg-white rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl border border-gray-100 transition-all duration-300 hover:-translate-y-2 cursor-pointer flex flex-col"
                                >
            ...
            {modalImage && (
                ...
                >
                    <button
                        onClick={() => setModalImage(null)}
                        className="absolute top-6 right-6 p-2 text-white/70 hover:text-white bg-white/10 hover:bg-white/20 rounded-full"
                    >
                        <X size={24} />
                    </button>
